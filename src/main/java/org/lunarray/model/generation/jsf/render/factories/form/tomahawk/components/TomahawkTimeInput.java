 ...
 *            The entity type.
 */
public final class TomahawkTimeInput<P, E>
		extends AbstractPropertyRenderStrategy<P, E> {

	/**
	 * Default constructor.
	 */
	protected TomahawkTimeInput() {
		super();
		// Default constructor.
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext renderContext) {
		...
		input.setType("time");
		input.setStyleClass(renderContext.resolveStyleClass(TomahawkStyleClasses.FORM_INPUT_TIME));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			return new TomahawkTimeInput<P, E>();
		}
	}
}
