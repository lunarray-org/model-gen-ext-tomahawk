 ...
 *            The entity type.
 */
public final class TomahawkDateInput<P, E>
		extends AbstractPropertyRenderStrategy<P, E> {

	/**
	 * Default constructor.
	 */
	protected TomahawkDateInput() {
		super();
		// Default constructor.
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext renderContext) {
		final HtmlInputCalendar calendar = new HtmlInputCalendar();
		calendar.setStyleClass(renderContext.resolveStyleClass(TomahawkStyleClasses.FORM_INPUT_DATE));
		return calendar;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			return new TomahawkDateInput<P, E>();
		}
	}
}
