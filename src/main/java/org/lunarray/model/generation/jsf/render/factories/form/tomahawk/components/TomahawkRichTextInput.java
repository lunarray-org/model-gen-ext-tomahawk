 ...
 *            The entity type.
 */
public final class TomahawkRichTextInput<P, E>
		extends AbstractPropertyRenderStrategy<P, E> {

	/**
	 * Default constructor.
	 */
	protected TomahawkRichTextInput() {
		super();
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext renderContext) {
		final InputHtml input = new InputHtml();
		input.setStyleClass(renderContext.resolveStyleClass(TomahawkStyleClasses.FORM_INPUT_RICH));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			return new TomahawkRichTextInput<P, E>();
		}
	}
}
